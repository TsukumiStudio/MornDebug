...
namespace MornLib
{
    internal sealed class MornDebugWindow : EditorWindow
    {
        ...
        private void DrawDebugUIToggle()
        {
            var isVisible = MornDebugUI.IsVisible;
            var defaultColor = GUI.backgroundColor;
            GUI.backgroundColor = isVisible ? Color.green : Color.red;
            var label = isVisible ? "Runtime UI: ON" : "Runtime UI: OFF";
